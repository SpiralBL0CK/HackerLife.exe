...
7. When you can't place objects to replace objects and only string, and they get encoded as unicode, and yet if you still bypass this, and yet you can't place 
